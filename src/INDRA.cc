...
void INDRA::indraGeo(G4LogicalVolume* logicWorld)
{
  //----------------Material --------------------
  ...
  G4Material* INDRACsI = new G4Material("INDRACsI", 4.51*g/CLHEP::cm3, 2, kStateSolid, labTemp);
  INDRACsI -> AddElement(elCs, 1);
  INDRACsI -> AddElement(elI,  1);
...
//Geometry information of each ring using polar angle coverage 
// -----------------------------------------------------
G4Material* scintillator_mat = nist -> FindOrBuildMaterial("INDRACsI");
...
double thetaF_16 = 156.3;
double dist_16 = 190.0;//mm
...
G4String Si6name[N_24];
G4String Si7name[N_24];
G4String Si8name[N_24];
G4String Si9name[N_24];

G4String CsI6name[N_24];
G4String CsI7name[N_24];
G4String CsI8name[N_24];
G4String CsI9name[N_24];
G4String CsI10name[N_24];
G4String CsI11name[N_24];
G4String CsI12name[N_24];
G4String CsI13name[N_24];

G4String CsI14name[N_16];
G4String CsI15name[N_16];

G4String CsI16name[N_8];
G4String CsI17name[N_8];

for(int N24 = 0; N24 < N_24 ; N24++)
{	
  Si6num[N24] = N24+260+601;
  Si7num[N24] = N24+285+601;
  Si8num[N24] = N24+310+601;
  Si9num[N24] = N24+335+601;

  CsI6num[N24] = N24+601;
  CsI7num[N24] = N24+25+601;
  CsI8num[N24] = N24+50+601;
  CsI9num[N24] = N24+75+601;
  CsI10num[N24] = N24+100+601;
  CsI11num[N24] = N24+125+601;
  CsI12num[N24] = N24+150+601;
  CsI13num[N24] = N24+175+601;
  
  int num624 = N24+601;
  int num724 = N24+701;
  int num824 = N24+801;
  int num924 = N24+901;
  int num1024 = N24+1001;
  int num1124 = N24+1101;
  int num1224 = N24+1201;
  int num1324 = N24+1301;

  G4String InttoString6 = G4UIcommand::ConvertToString(num624);  
  G4String InttoString7 = G4UIcommand::ConvertToString(num724);  
  G4String InttoString8 = G4UIcommand::ConvertToString(num824);  
  G4String InttoString9 = G4UIcommand::ConvertToString(num924);  
  G4String InttoString10 = G4UIcommand::ConvertToString(num1024);  
  G4String InttoString11 = G4UIcommand::ConvertToString(num1124);  
  G4String InttoString12 = G4UIcommand::ConvertToString(num1224);  
  G4String InttoString13 = G4UIcommand::ConvertToString(num1324);  
  
  Si6name[N24] = ("INDRA_Si"+InttoString6);
  Si7name[N24] = ("INDRA_Si"+InttoString7);
  Si8name[N24] = ("INDRA_Si"+InttoString8);
  Si9name[N24] = ("INDRA_Si"+InttoString9);
  
  CsI6name[N24] = ("INDRA_CsI"+InttoString6);
  CsI7name[N24] = ("INDRA_CsI"+InttoString7);
  CsI8name[N24] = ("INDRA_CsI"+InttoString8);
  CsI9name[N24] = ("INDRA_CsI"+InttoString9);
  CsI10name[N24] = ("INDRA_CsI"+InttoString10);
  CsI11name[N24] = ("INDRA_CsI"+InttoString11);
  CsI12name[N24] = ("INDRA_CsI"+InttoString12);
  CsI13name[N24] = ("INDRA_CsI"+InttoString13);
 // cout << "name of INDRA Si ring" <<Si6name[N_24] << endl; 
}

for(int N16 = 0; N16 < N_16 ; N16++)
{	
  CsI14num[N16] = N16+200+601;
  CsI15num[N16] = N16+220+601;
  
  int num1424 = N16+1401;
  int num1524 = N16+1501;
  
  G4String InttoString14 = G4UIcommand::ConvertToString(num1424);  
  G4String InttoString15 = G4UIcommand::ConvertToString(num1524);  
  
  CsI14name[N16] = ("INDRA_CsI"+InttoString14);
  CsI15name[N16] = ("INDRA_CsI"+InttoString15);
}	

for(int N8 = 0; N8 < N_8 ; N8++)
{	
  CsI16num[N8] = N8+240+601;
  CsI17num[N8] = N8+250+601;
  
  int num1624 = N8+1601;
  int num1724 = N8+1701;
  
  G4String InttoString16 = G4UIcommand::ConvertToString(num1624);  
  G4String InttoString17 = G4UIcommand::ConvertToString(num1724);  
  
  CsI16name[N8] = ("INDRA_CsI"+InttoString16);
  CsI17name[N8] = ("INDRA_CsI"+InttoString17);
}

/*for(int Int24 = 0 ; Int24 < N_24 ; Int24++)
{
  G4String InttoString = G4UIcommand::ConvertToString(Int24+600);
  string Si6name[N_24] = {"INDRA_Si"+InttoString};
}*/	
...
/*string Si6name[N_24] = {"Si600","Si601","Si602","Si603","Si604","Si605","Si606","Si607","Si608","Si609","Si610","Si611",
  "Si612","Si613","Si614","Si615","Si604","Si605","Si606","Si607","Si608","Si609","Si610","Si611"};*/
...
for(int NB = 0 ; NB < N_24 ; NB++)
{
  ...
  logicalDetectorS6[NB] = new G4LogicalVolume(Si6[NB] ,Silicon_mat ,Si6name[NB]);
  ...
  logicalDetectorS7[NB] = new G4LogicalVolume(Si7[NB] ,Silicon_mat ,Si7name[NB]);
  ...
  logicalDetectorS8[NB] = new G4LogicalVolume(Si8[NB] ,Silicon_mat ,Si8name[NB]);
  ...
  logicalDetectorS9[NB] = new G4LogicalVolume(Si9[NB] ,Silicon_mat ,Si9name[NB]);
