...
G4VPhysicalVolume* FAZIADetectorConstruction::Construct()
{
  ...
  G4int silicon_11Num[blkcor][tel] = {{1,6,11,16},//
	{22,27,32,17},//+16 // add +16 and push a array number
	{43,48,33,38},//+32 // add +32 and push two array number
	{64,49,54,59}};//+48 // add +48 and push three array number
  ...
  G4int silicon_21Num[blkcor][tel] = {{2,7,12,13},//
	{23,28,29,18},//+16
	{44,45,34,39},//+32
	{61,50,55,60}};//+48
  ...
  G4int silicon_31Num[blkcor][tel] = {{4,5,10,15},//
	{21,26,31,20},//+16
	{42,47,36,37},//+32
	{63,52,53,58}};//+48
  ...
  G4int silicon_41Num[blkcor][tel] = {{3,8,9,14},//
	{24,25,30,19},//+16
	{41,46,35,40},//+32
	{62,51,56,57}};//+48
  ...
  G4int silicon_521Num[blkcor][tel] = {{82,87,92,93},//+80 (2,7,12,13)
	{124,125,114,119},//+112 7
	{151,156,157,146},//+144 9
  ...
  G4int silicon_541Num[blkcor][tel] = {{83,88,89,94},//+80 (3,8,9,14)
	{121,126,115,120},//+112 7
	{152,153,158,147},//+144 9
